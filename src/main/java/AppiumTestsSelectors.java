...
public class AppiumTestsSelectors {
    ...
    public static final By languageListByIDSelector = new By.ById("js-lang-lists");
    public static final By languagesListByCSSSelector = new By.ByCssSelector(".langlist.hlist");
}
